...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={`inline-flex h-9 items-center justify-center rounded-lg bg-gray-100 dark:bg-slate-800 p-1 text-gray-500 dark:text-gray-400 ${className}`}
    {...props}
  />
));
